...
import { COMMON_CONSTANTS } from '../../src/api/constants';
import { ProviderConfig, StructuredOutput } from '../../src/api/types';
import { PROVIDER_NAMES } from '../../src/utils';
...
import { LMStudio } from '../../src/api/providers/LMStudio';
import { Ollama } from '../../src/api/providers/Ollama';
import { getProvider, sendRequest } from '../../src/api/index';
...
describe('processAPIRequest and testModel', () => {
        ...
        let processAPIRequest: (typeof import('../../src/api/index'))['processAPIRequest'];
        let testModel: (typeof import('../../src/api/index'))['testModel'];

        beforeAll(() => {
                jest.resetModules();
                jest.doMock('../../src/api/providers/OpenAI', () => {
                        return {
